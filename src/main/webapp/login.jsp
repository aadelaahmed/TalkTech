    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="width: 600px;">
                <form class="loginForm" id="signin" style="width: 500px; margin: auto; width: 60%;">
                    <div class="row">

                        <div class=" col-md-12" >   <!--onblur="validateEmail()"-->

                            <input class="form-control"  placeholder="E-mail" type="text" name="email" id="email" required>
                        </div>
                        ...
                        <div class=" col-md-12">
                            <button type="button"  onclick="SignIn()" style="width: 100px; height: 50px;" class="send" name="login" value="Login">Sign In</button>
