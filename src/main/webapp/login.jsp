            ...
            <div class="col-md-12" style="width: 600px;">
                <form class="loginForm" action="index.jsp"  method="GET" style="width: 500px; margin: auto; width: 60%;">
                    <div class="row">
                        ...
                        <div class=" col-md-12" >
                            <input class="form-control"  placeholder="E-mail" type="text" name="Phone" required>
                        </div>
                        ...
                        <div class=" col-md-12">
                            <button type="submit" style="width: 100px; height: 50px;" class="send" name="login" value="Login" >Sign In</button>
                        </div>
