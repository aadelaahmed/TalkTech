      ...
      function validateEmail() {
      				...
      				req.onreadystatechange = function () {
      					if (req.readyState == 4 && req.status == 200) {
      						...
      						document.getElementById("emailValidate").innerHTML = xmlvalue;
      					}
      					else {
      					    var xmlvalue = req.responseText;
      						document.getElementById("emailValidate").innerHTML = xmlvalue;
                ...
                <form class="signUP_form"  id="register" style="width: 500px; margin: auto; width: 60%;" >
                    ...
                    <div class="row" style="width: 500px;">
                        ...
                        <div class=" col-md-12" style="width: 200px;">
                            <label for="password">Password*:</label><label id="passvalidation" style="color: crimson;"></label>
                        ...
                        <div class=" col-md-12" style="width: 200px;">
                            <label for="email">Email*:</label><label id="emailValidate" style="color: crimson;"></label>
                            <input class="form-control" type="text" id="email" name="email" onblur="validateEmail()"  required >
                        </div>
                        <div class=" col-md-12" style="width: 200px;">
                        ...
                        <div class="col-md-12">
                            <button type="button" class="send" name="register" value="register" onclick="SignUp()">Submit</button>
                        </div>
